...
## Overview
Developers write code, but they also *write about code*. Create a tutorial that explains how a specific regular expression, or regex, functions by breaking down each part of the expression and describing what it does. Use the template provided in the starter code to create the walkthrough.

## What Is a Regex?
A **regex**, which is short for **regular expression**, is a sequence of characters that defines a specific search pattern. When included in code or search algorithms, regular expressions can be used to find certain patterns of characters within a string, or to find and replace a character or sequence of characters within a string. They are also frequently used to validate input. The following are regex options can be selected for this project: 
...
Instead of creating a repository, publish a GitHub gist. GitHub describes a **gist** as a simple way to share code snippets with others. It’s also an ideal way to demonstrate a technique, teach a principle, or show off a solution. Use Markdown to create it, just like a README. Gists can include code, images, links, and anything else that can be included in a README. Be sure to rename the template to a unique name that describes the tutorial.
...
The regular expression choosen might not include all of the components outlined in the starter code. After finishing the walkthrough, remove any sections that weren't used.
...
> **Important**: Make sure to create a **public** gist and add the `.md` file extension to the file name so that the Markdown renders correctly. Make revisions to the gist in the GitHub gist UI in order to create a revision history.

## Resources Used 

### Helpful References
- [GitHub Docs: Creating gists](https://help.github.com/en/github/writing-on-github/creating-gists)
- [How to Use Gists (Github) by Digital Horizon - YouTube Video](https://www.youtube.com/watch?v=wc2NlcWjQHw)
- [2.1: Introduction to Regular Expressions - Programming with Text by The Coding Train - YouTube Video](https://youtu.be/7DG3kCDx53c)
